...
// import { Typography, Divider, Card, Avatar, Space } from 'antd';
...
//   return (
//     <div className="relative bg-[#1E1F29] text-white w-[428px] h-[1200px] mx-auto p-6 rounded-lg shadow-lg transition-transform duration-500 ease-in-out transform hover:scale-[1.03] hover:shadow-2xl">
...
//         <Title level={3} className="font-semibold text-[22px] leading-[28px] text-white tracking-wide transition-colors duration-300 hover:text-[#00D4FF]">
//           {name}
//         </Title>
...
//         <Title level={3} className="text-white text-[16px] font-semibold">About Me</Title>
...
//         <Title level={3} className="text-white text-[16px] font-semibold">Contact Information</Title>
//         <Text className="text-[#D0D0D0]">Email: {email}</Text><br />
//         <Text className="text-[#D0D0D0]">Mobile: {mobile}</Text><br />
//         <Text className="text-[#D0D0D0]">Date of Birth: {dob}</Text><br />
//         <Text className="text-[#D0D0D0]">Location: {location}</Text>
//       </Card>

//       {/* Appointment Section */}
//       <Card className="mt-6 bg-[#2A2B35] border-none rounded-lg shadow-lg w-[360px] mx-auto p-5 transition-transform duration-500 hover:translate-y-1 hover:shadow-2xl">
//         <Title level={3} className="text-white text-[16px] font-semibold">Appointment</Title>
//         <div className="text-[#D0D0D0]">
//           <Text className="block text-[14px] font-semibold">Date:</Text>
//           <Text className="text-[14px]">{appointmentDate}</Text>
//           <br />
//           <Text className="block text-[14px] font-semibold">Available Hours:</Text>
//           <Text className="text-[14px]">{availableHours}</Text>
//         </div>
//       </Card>
//     </div>
//   );
